...
where distances.location_name = 'Ballard'
...
insert into locations values ('UDistrict', '4145 11th Ave NE', 'Seattle', 'WA', 'USA', 47.65823741352416, -122.31706748625146, 5);

insert into locations values ('Oakland Bushrod', '560 59th St', 'Oakland', 'CA', 'USA', 37.845492768632845, -122.26365184780283, 5);
